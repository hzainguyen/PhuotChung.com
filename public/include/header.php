...
<body>
	...
	<div id="tab_nav" class="sidenav">
	  	...
	  	<ul class="clearfix">
			...
			<li><a href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-volume-control-phone fa-fw"></i> Login</a></li>
		</ul>
	</div>
			...
			<div class="tab-content">
			  	<div class="tab-pane fade in active" id="place_search">
			  		<ul>
			  			<li class="clearfix">
			  				<a href="?page=page_2">
				  				<div class="col-xs-5 item-search-image"><img class="full-img" src="public/images/home_page/place_3.jpg" alt=""></div>
			  			...
			  			<li class="clearfix">
			  				<a href="?page=page_2">
				  				<div class="col-xs-5 item-search-image"><img class="full-img" src="public/images/home_page/place_2.jpg" alt=""></div>
				  				<div class="col-xs-7 item-search-desc">
				  					<p class="title">Lorem Ipsum is simply dummy text </p>
				  					<p>It has survived only five</p>
				  				</div>
			  			...
			  			<li class="clearfix">
			  				<a href="?page=page_2">
				  				<div class="col-xs-5 item-search-image"><img class="full-img" src="public/images/home_page/place_4.jpg" alt=""></div>
				  				<div class="col-xs-7 item-search-desc">
				  					<p class="title">Lorem Ipsum is simply dummy text </p>
				  					<p>It has survived only five</p>
				  				</div>
	  		...
	  		<!-- <ul>
	  			<li class="clearfix">
	  				<div class="col-xs-5"><img class="full-img" src="public/images/home_page/place_3.jpg" alt=""></div>
	  				<div class="col-xs-7">
	  					<p class="title">Lorem Ipsum is simply dummy text </p>
	  					<p>It has survived only five</p>
	  				</div>
	  			...
	  			<li class="clearfix">
	  				<div class="col-xs-5"><img class="full-img" src="public/images/home_page/place_2.jpg" alt=""></div>
	  				<div class="col-xs-7">
	  					<p class="title">Lorem Ipsum is simply dummy text </p>
	  					<p>It has survived only five</p>
	  				</div>
	  			...
	  			<li class="clearfix">
	  				<div class="col-xs-5"><img class="full-img" src="public/images/home_page/place_4.jpg" alt=""></div>
	  				<div class="col-xs-7">
	  					<p class="title">Lorem Ipsum is simply dummy text </p>
	  					<p>It has survived only five</p>
	  				</div>
