  ...
  <div class="row" style="margin-top:0px;background-color: #e5e5e5;">
    <div id="left" class="col-lg-3 col-xs-12 col-md-3 col-sm-12">
      <div class="panel-group" id="accordion">
        <div class="panel panel-default">
          <div>
            <button id="btn-filter" class="btn btn-info" data-toggle="collapse" data-parent="#accordion"
                    href="#collapseOne">BỘ LỌC
            </button>
          </div>
    ...
    <div id="grid-model" class="col-lg-9 col-xs-12 col-md-9 col-sm-9" style="display:none; ">
      <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          <button id="btn-grid" class="btn btn-default btn-lg btn-switch"><span class="glyphicon glyphicon-th"></span>
            Grid
          </button>
        </div>
      </div>
      <div class="row">
        <div class="result">
          ...
          <div class="vote-list">
            <a href="index.php?page=page_2" class="like-icon"><span class="glyphicon glyphicon-thumbs-up"
    ...
    <div id="list-model" class="col-lg-9 col-xs-12 col-md-9 col-sm-9" style=" display:block;">
      <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          <button id="btn-list" class="btn btn-default btn-lg btn-switch"><span
      ...
      <div class="row row-list">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7" style="">
          <div class="detail-list">
            ...
            <p style="margin-top: 10px;padding-right: 50px;font-size: 18px;"> Mộc Châu là cao nguyên rộng lớn và xinh
              đẹp nhất miền núi phía bắc, có khí hậu ôn đới gió mùa, các điểm du lịch nổi tiếng như: Hang Doi, rừng
              thông Mộc Châu, thác Thái Hưng...</p>

            <div class="row">
              <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <p><b>Số người:</b> 4</p>
                <p><b>Chi phí:</b> 5 Triệu (Tất cả)</p>
                <p style="margin-bottom: 10px;"><b> Đăng bởi: </b><a href="index.php?page=page_2">Nguyễn Minh Hiếu</a>
                </p>
              </div>
              <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                <div class="row" style="margin-top:15px;">

                  <a href="public/images/mocchau1.jpg" data-lightbox="mocchau"
                     data-title="Bộ ảnh tuyệt đẹp về sapa, Thiên đường nghỉ mát là đây !!!"><img
                    class="post-image-show small-img" data-u="image" src="public/images/mocchau1.jpg"/></a>


                  <a href="public/images/mocchau2.jpg" data-lightbox="mocchau"
                     data-title="Bộ ảnh tuyệt đẹp về sapa, Thiên đường nghỉ mát là đây !!!"><img
                    class="post-image-show small-img" data-u="image" src="public/images/mocchau2.jpg"/></a>


                  <a href="public/images/mocchau3.jpg" data-lightbox="mocchau"
                     data-title="Bộ ảnh tuyệt đẹp về sapa, Thiên đường nghỉ mát là đây !!!"><img
                    class="post-image-show small-img" data-u="image" src="public/images/mocchau3.jpg"/></a>
      ...
      <div class="row row-list">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7" style="">
          <div class="detail-list">
            ...
            <p style="margin-top: 10px;padding-right: 50px;font-size: 18px;"> Với 4 ngày cùng bạn bè đi dạo trên bãi
              biển đầy nắng và gió bạn sẽ cảm thấy thiên nhiên thật tuyệt. Đây là 1 địa điểm lý tưởng cho mùa hè nóng
              bức.</p>
            <div class="row">
              <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <p><b>Số người:</b> 3-7</p>
                <p><b>Chi phí:</b> 1.5 Triệu(Mỗi người)</p>
                <p style="margin-bottom: 10px;"><b> Đăng bởi: </b><a href="index.php?page=page_2">Nguyễn Quang Hiếu</a>
                </p>
              </div>
              <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                <div class="row" style="margin-top:15px;">
                  <a href="public/images/page_2/img/01.jpg" data-lightbox="roadtrip"
                     data-title="Bộ ảnh tuyệt đẹp về sapa, Thiên đường nghỉ mát là đây !!!"><img
                    class="post-image-show small-img" data-u="image" src="public/images/page_2/img/01.jpg"/></a>
                  <a href="public/images/page_2/img/01.jpg" data-lightbox="roadtrip"
                     data-title="Bộ ảnh tuyệt đẹp về sapa, Thiên đường nghỉ mát là đây !!!"><img
                    class="post-image-show small-img" data-u="image" src="public/images/page_2/img/01.jpg"/></a>
                  <a href="public/images/page_2/img/01.jpg" data-lightbox="roadtrip"
      ...
      <div class="row row-list">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7" style="">
          <div class="detail-list">
            ...
            <p style="margin-top: 10px;padding-right: 50px;font-size: 18px;">Mệnh danh là "Hòn ngọc viễn Đông", Nha
              Trang không chỉ sở hữu thiên nhiên trong lành,những hòn đảo ngoài khơi có hệ sinh thái san hô kỳ ảo, mà
              còn nổi tiếng bởi có nhiều ngôi đền Chăm cổ kính rêu phong.</p>
            <div class="row">
              <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <p><b>Số người:</b> 3</p>
